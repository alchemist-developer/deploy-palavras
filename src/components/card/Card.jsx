        ...
        <>
            <S.CardContainer>
                <S.CardContent>
                    ...
                    <Typography fontSize="24px" fontWeight="600" padding="0 16px 16px 16px" text="Mariana Prado/Parceira/International Youth Day" />
                ...
                <S.CardContent>
                    ...
                    <Typography fontSize="24px" fontWeight="600" padding="0 16px 16px 16px" text="
Silene/Voluntária"/>
                </S.CardContent>
            </S.CardContainer>
        </>
